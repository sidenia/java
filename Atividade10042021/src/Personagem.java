...
public class Personagem {
	...
	/*Bloco construtor - 
	mostra a forma como construir o objeto dentro da memória (atraves dos parametros e se quiser valores pros atributos).
	...
	//métodos de acesso = são os famosos get ou getters - 
	//precisam do nivel(ex: public), do tipo de dado (ex: int, String,etc)  e (get + nome do atributo)
	...
	//métodos modificadores = são os famosos metodos setters - Deve-se declarar:
	// nível + são sempre void + setAtributo (tipo atributo)
	
	public void setNome (String nome) {
		//this fala para pegar o atributo nome desse objeto			
		this.nome = nome;
					//e atribuir a esse parametro fome
	}
	
	public void setFome (int fome) {
		if (fome >= 0 && fome <=8) {   //regras de negócio
			this.fome = fome;
		}
	}
